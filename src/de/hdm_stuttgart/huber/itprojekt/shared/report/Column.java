...
public class Column implements Serializable {
	 ...
	 * In dieser Realisierung handelt es sich um einen einfachen textuellen
	 * Wert.
	 */
	 ...
	 * aber dennoch einen No-Argument-Konstruktor benötigen, müssen wir diesen
	 ...
	 * 
	 * @param s
	 *            der Wert, der durch das Column-Objekt dargestellt werden soll.
	 * @see #Column()
	 */
