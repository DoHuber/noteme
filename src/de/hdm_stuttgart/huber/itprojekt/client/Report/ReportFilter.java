 ...
 * Durch Anchor gelangt der Admin jeweils auf eine neue Seite f�r den entsprechenden Report
...
public class ReportFilter extends VerticalPanel{
	...
	Anchor showAllNotebooks = new Anchor("Ausgabe aller Notizb�cher");
	Anchor backToNoteMe = new Anchor("Zur�ck zu NoteMe");
