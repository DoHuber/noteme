...
public class SourceMapper extends DataMapper {
	...
	// Statisches Attribut, welches den Singleton-SourceMapper enth�lt
	...
	// �ffentliche statische Methode, um den Singleton-SourceMapper zu erhalten
	...
	public Source create(Source source) throws ClassNotFoundException, SQLException {
		...
		try {
			PreparedStatement stmt = con.prepareStatement("INSERT INTO source(Url)" + "VALUES (?)",
